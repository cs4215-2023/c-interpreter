...
export default class Heap extends MemoryBuffer {
    ...
    public allocate_literal_values = () => {
        ...
        this.undefined = this.heap_allocate(TAGS.Undefined_tag, 1) //probably don't need this
    }
    ...
    public is_Builtin = (address: number) =>
        this.mem_get_tag(address) === TAGS.Builtin_tag
    ...
    public heap_get_Builtin_id = (address: number) =>
        this.mem_get_byte_at_offset(address, 1)
    ...
    public heap_get_Closure_arity = (address: number) =>
        this.mem_get_byte_at_offset(address, 1)

    public heap_get_Closure_environment = (address: number) =>
        this.mem_get_child(address, 0)

    public is_Closure = (address: number) =>
        this.mem_get_tag(address) === TAGS.Closure_tag
    ...
    public is_Blockframe = (address: number) =>
        this.mem_get_tag(address) === TAGS.Blockframe_tag
    ...
    public is_Callframe = (address: number) =>
        this.mem_get_tag(address) === TAGS.Callframe_tag
