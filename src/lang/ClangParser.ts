...
export class ClangParser extends Parser {
	...
	public static readonly ruleNames: string[] = [
		...
		"postFix", "conditionalExpression", "expressionStatement", "selectionStatement", 
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 10:
						...
						this.state = 161;
						(_localctx as GreaterThanOrEqualContext)._operator = this.match(ClangParser.T__15);
						this.state = 162;
					...
					case 11:
						...
						this.state = 164;
						(_localctx as LesserThanOrEqualContext)._operator = this.match(ClangParser.T__16);
						this.state = 165;
					...
					case 12:
						...
						this.state = 167;
						(_localctx as EqualityCheckingContext)._operator = this.match(ClangParser.T__17);
						this.state = 168;
					...
					case 20:
						...
						this.state = 191;
						(_localctx as AssignAndMinusOneContext)._operator = this.match(ClangParser.T__25);
						this.state = 192;
