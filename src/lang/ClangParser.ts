...
export class ClangParser extends Parser {
	...
	public static readonly RULE_condExpressionStatement = 15;
	public static readonly RULE_condExpression = 16;
	public static readonly RULE_returnStatement = 17;
	public static readonly RULE_expressionStatement = 18;
	public static readonly RULE_conditionalStatement = 19;
	public static readonly RULE_iterationStatement = 20;
	public static readonly RULE_whileLoop = 21;
	public static readonly RULE_doWhileLoop = 22;
	public static readonly RULE_forLoop = 23;
	public static readonly RULE_forCondition = 24;
	public static readonly RULE_arrayIdentifierWithType = 25;
	public static readonly RULE_arrayContent = 26;
	public static readonly RULE_arrayInitialisation = 27;
	public static readonly RULE_pointer = 28;
	public static readonly RULE_pointerDerefernce = 29;
	public static readonly RULE_pointerReference = 30;
	public static readonly RULE_functionDeclaration = 31;
	public static readonly RULE_function = 32;
	public static readonly RULE_functionCall = 33;
	public static readonly RULE_functionCallParameters = 34;
	public static readonly RULE_printf = 35;
	// tslint:disable:no-trailing-whitespace
	public static readonly ruleNames: string[] = [
		"start", "stringLiteral", "stringLiteralList", "identifierWithType", "type", 
		"identifierWithTypeList", "identifierList", "expressionList", "numberList", 
		"pointerList", "statement", "expression", "statementBlock", "parenthesesExpression", 
		"postFix", "condExpressionStatement", "condExpression", "returnStatement", 
	...
	public start(): StartContext {
		...
		try {
			...
			while ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << ClangParser.T__0) | (1 << ClangParser.T__2) | (1 << ClangParser.T__7) | (1 << ClangParser.T__8) | (1 << ClangParser.T__12) | (1 << ClangParser.T__13) | (1 << ClangParser.T__14) | (1 << ClangParser.T__17) | (1 << ClangParser.MUL) | (1 << ClangParser.ADD) | (1 << ClangParser.SUB))) !== 0) || ((((_la - 34)) & ~0x1F) === 0 && ((1 << (_la - 34)) & ((1 << (ClangParser.NOT - 34)) | (1 << (ClangParser.BITWISEAND - 34)) | (1 << (ClangParser.PRIMITIVETYPE - 34)) | (1 << (ClangParser.SIGNEDTYPE - 34)) | (1 << (ClangParser.IDENTIFIER - 34)) | (1 << (ClangParser.NUMBER - 34)) | (1 << (ClangParser.CHAR - 34)) | (1 << (ClangParser.FLOAT - 34)))) !== 0)) {
				{
				{
				this.state = 72;
				this.statement();
	...
	// @RuleVersion(0)
	public condExpressionStatement(): CondExpressionStatementContext {
		let _localctx: CondExpressionStatementContext = new CondExpressionStatementContext(this._ctx, this.state);
		this.enterRule(_localctx, 30, ClangParser.RULE_condExpressionStatement);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 255;
			_localctx._conditionalExpression = this.condExpression();
			this.state = 256;
	...
	// @RuleVersion(0)
	public condExpression(): CondExpressionContext {
		let _localctx: CondExpressionContext = new CondExpressionContext(this._ctx, this.state);
		this.enterRule(_localctx, 32, ClangParser.RULE_condExpression);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			...
			if (_la === ClangParser.T__5) {
				...
				this.state = 262;
				_localctx._alternate = this.condExpression();
				}
			}
	...
	public returnStatement(): ReturnStatementContext {
		...
		this.enterRule(_localctx, 34, ClangParser.RULE_returnStatement);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
	...
	public expressionStatement(): ExpressionStatementContext {
		...
		this.enterRule(_localctx, 36, ClangParser.RULE_expressionStatement);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 272;
	...
	public conditionalStatement(): ConditionalStatementContext {
		...
		this.enterRule(_localctx, 38, ClangParser.RULE_conditionalStatement);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
	...
	public iterationStatement(): IterationStatementContext {
		...
		this.enterRule(_localctx, 40, ClangParser.RULE_iterationStatement);
		try {
			this.state = 295;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
	...
	public whileLoop(): WhileLoopContext {
		...
		this.enterRule(_localctx, 42, ClangParser.RULE_whileLoop);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 297;
	...
	public doWhileLoop(): DoWhileLoopContext {
		...
		this.enterRule(_localctx, 44, ClangParser.RULE_doWhileLoop);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 305;
	...
	public forLoop(): ForLoopContext {
		...
		this.enterRule(_localctx, 46, ClangParser.RULE_forLoop);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 315;
	...
	public forCondition(): ForConditionContext {
		...
		this.enterRule(_localctx, 48, ClangParser.RULE_forCondition);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
	...
	public arrayIdentifierWithType(): ArrayIdentifierWithTypeContext {
		...
		this.enterRule(_localctx, 50, ClangParser.RULE_arrayIdentifierWithType);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
	...
	public static readonly _serializedATN: string =
		...
		"\t#\x04$\t$\x04%\t%\x03\x02\x07\x02L\n\x02\f\x02\x0E\x02O\v\x02\x03\x03" +
		"\x03\x03\x05\x03S\n\x03\x03\x03\x03\x03\x03\x04\x03\x04\x03\x04\x07\x04" +
		"Z\n\x04\f\x04\x0E\x04]\v\x04\x03\x05\x03\x05\x03\x05\x03\x06\x05\x06c" +
		"\n\x06\x03\x06\x03\x06\x03\x07\x03\x07\x03\x07\x07\x07j\n\x07\f\x07\x0E" +
		"\x07m\v\x07\x03\b\x03\b\x03\b\x07\br\n\b\f\b\x0E\bu\v\b\x03\t\x03\t\x03" +
		"\t\x07\tz\n\t\f\t\x0E\t}\v\t\x03\n\x03\n\x03\n\x07\n\x82\n\n\f\n\x0E\n" +
		"\x85\v\n\x03\v\x03\v\x03\v\x07\v\x8A\n\v\f\v\x0E\v\x8D\v\v\x03\f\x03\f" +
		"\x03\f\x03\f\x03\f\x03\f\x05\f\x95\n\f\x03\r\x03\r\x03\r\x03\r\x03\r\x03" +
		...
		"\x03\x15\x03\x15\x03\x15\x03\x15\x03\x15\x03\x15\x03\x15\x05\x15\u0123" +
		"\n\x15\x05\x15\u0125\n\x15\x03\x16\x03\x16\x03\x16\x05\x16\u012A\n\x16" +
		...
		"\x03\x1A\x03\x1A\x05\x1A\u0149\n\x1A\x03\x1A\x03\x1A\x03\x1A\x03\x1B\x03" +
		"\x1B\x03\x1B\x03\x1B\x05\x1B\u0152\n\x1B\x03\x1B\x03\x1B\x03\x1C\x03\x1C" +
		"\x03\x1C\x03\x1C\x05\x1C\u015A\n\x1C\x03\x1C\x03\x1C\x03\x1D\x03\x1D\x03" +
		"\x1D\x03\x1D\x05\x1D\u0162\n\x1D\x03\x1E\x03\x1E\x03\x1E\x03\x1E\x03\x1F" +
		"\x03\x1F\x03\x1F\x03 \x03 \x03 \x03!\x03!\x03\"\x03\"\x03\"\x03\"\x05" +
		"\"\u0174\n\"\x03\"\x03\"\x03\"\x03\"\x03\"\x03\"\x03#\x03#\x03#\x03#\x03" +
		"#\x03$\x03$\x03%\x03%\x03%\x07%\u0186\n%\f%\x0E%\u0189\v%\x03%\x03%\x03" +
		"%\x03%\x03%\x02\x02\x03\x18&\x02\x02\x04\x02\x06\x02\b\x02\n\x02\f\x02" +
		"\x0E\x02\x10\x02\x12\x02\x14\x02\x16\x02\x18\x02\x1A\x02\x1C\x02\x1E\x02" +
		" \x02\"\x02$\x02&\x02(\x02*\x02,\x02.\x020\x022\x024\x026\x028\x02:\x02" +
		"<\x02>\x02@\x02B\x02D\x02F\x02H\x02\x02\x03\x03\x0245\x02\u01AD\x02M\x03" +
		"\x02\x02\x02\x04P\x03\x02\x02\x02\x06V\x03\x02\x02\x02\b^\x03\x02\x02" +
		"\x02\nb\x03\x02\x02\x02\ff\x03\x02\x02\x02\x0En\x03\x02\x02\x02\x10v\x03" +
		"\x02\x02\x02\x12~\x03\x02\x02\x02\x14\x86\x03\x02\x02\x02\x16\x94\x03" +
		"\x02\x02\x02\x18\xAE\x03\x02\x02\x02\x1A\xF7\x03\x02\x02\x02\x1C\xFA\x03" +
		"\x02\x02\x02\x1E\xFE\x03\x02\x02\x02 \u0101\x03\x02\x02\x02\"\u0104\x03" +
		"\x02\x02\x02$\u010C\x03\x02\x02\x02&\u0112\x03\x02\x02\x02(\u0115\x03" +
		"\x02\x02\x02*\u0129\x03\x02\x02\x02,\u012B\x03\x02\x02\x02.\u0133\x03" +
		"\x02\x02\x020\u013D\x03\x02\x02\x022\u0145\x03\x02\x02\x024\u014D\x03" +
		"\x02\x02\x026\u0155\x03\x02\x02\x028\u015D\x03\x02\x02\x02:\u0163\x03" +
		"\x02\x02\x02<\u0167\x03\x02\x02\x02>\u016A\x03\x02\x02\x02@\u016D\x03" +
		"\x02\x02\x02B\u016F\x03\x02\x02\x02D\u017B\x03\x02\x02\x02F\u0180\x03" +
		"\x02\x02\x02H\u0182\x03\x02\x02\x02JL\x05\x16\f\x02KJ\x03\x02\x02\x02" +
		"LO\x03\x02\x02\x02MK\x03\x02\x02\x02MN\x03\x02\x02\x02N\x03\x03\x02\x02" +
		"\x02OM\x03\x02\x02\x02PR\x07\x03\x02\x02QS\x07/\x02\x02RQ\x03\x02\x02" +
		"\x02RS\x03\x02\x02\x02ST\x03\x02\x02\x02TU\x07\x03\x02\x02U\x05\x03\x02" +
		"\x02\x02V[\x05\x04\x03\x02WX\x07\x04\x02\x02XZ\x05\x04\x03\x02YW\x03\x02" +
		"\x02\x02Z]\x03\x02\x02\x02[Y\x03\x02\x02\x02[\\\x03\x02\x02\x02\\\x07" +
		"\x03\x02\x02\x02][\x03\x02\x02\x02^_\x05\n\x06\x02_`\x07/\x02\x02`\t\x03" +
		"\x02\x02\x02ac\x07.\x02\x02ba\x03\x02\x02\x02bc\x03\x02\x02\x02cd\x03" +
		"\x02\x02\x02de\x07-\x02\x02e\v\x03\x02\x02\x02fk\x05\b\x05\x02gh\x07\x04" +
		"\x02\x02hj\x05\b\x05\x02ig\x03\x02\x02\x02jm\x03\x02\x02\x02ki\x03\x02" +
		"\x02\x02kl\x03\x02\x02\x02l\r\x03\x02\x02\x02mk\x03\x02\x02\x02ns\x07" +
		"/\x02\x02op\x07\x04\x02\x02pr\x07/\x02\x02qo\x03\x02\x02\x02ru\x03\x02" +
		"\x02\x02sq\x03\x02\x02\x02st\x03\x02\x02\x02t\x0F\x03\x02\x02\x02us\x03" +
		"\x02\x02\x02v{\x05\x18\r\x02wx\x07\x04\x02\x02xz\x05\x18\r\x02yw\x03\x02" +
		"\x02\x02z}\x03\x02\x02\x02{y\x03\x02\x02\x02{|\x03\x02\x02\x02|\x11\x03" +
		"\x02\x02\x02}{\x03\x02\x02\x02~\x83\x071\x02\x02\x7F\x80\x07\x04\x02\x02" +
		"\x80\x82\x071\x02\x02\x81\x7F\x03\x02\x02\x02\x82\x85\x03\x02\x02\x02" +
		"\x83\x81\x03\x02\x02\x02\x83\x84\x03\x02\x02\x02\x84\x13\x03\x02\x02\x02" +
		"\x85\x83\x03\x02\x02\x02\x86\x8B\x05:\x1E\x02\x87\x88\x07\x04\x02\x02" +
		"\x88\x8A\x05:\x1E\x02\x89\x87\x03\x02\x02\x02\x8A\x8D\x03\x02\x02\x02" +
		"\x8B\x89\x03\x02\x02\x02\x8B\x8C\x03\x02\x02\x02\x8C\x15\x03\x02\x02\x02" +
		"\x8D\x8B\x03\x02\x02\x02\x8E\x95\x05&\x14\x02\x8F\x95\x05(\x15\x02\x90" +
		"\x95\x05*\x16\x02\x91\x95\x05$\x13\x02\x92\x95\x05@!\x02\x93\x95\x05 " +
		"\x11\x02\x94\x8E\x03\x02\x02\x02\x94\x8F\x03\x02\x02\x02\x94\x90\x03\x02" +
		"\x02\x02\x94\x91\x03\x02\x02\x02\x94\x92\x03\x02\x02\x02\x94\x93\x03\x02" +
		"\x02\x02\x95\x17\x03\x02\x02\x02\x96\x97\b\r\x01\x02\x97\xAF\x05\b\x05" +
		"\x02\x98\xAF\x071\x02\x02\x99\xAF\x072\x02\x02\x9A\xAF\x073\x02\x02\x9B" +
		"\xAF\x05\x04\x03\x02\x9C\xAF\x07/\x02\x02\x9D\xAF\x05\x1E\x10\x02\x9E" +
		"\xAF\x058\x1D\x02\x9F\xA0\x07\x05\x02\x02\xA0\xA1\x05\x18\r\x02\xA1\xA2" +
		"\x07\x06\x02\x02\xA2\xAF\x03\x02\x02\x02\xA3\xAF\x05:\x1E\x02\xA4\xAF" +
		"\x05<\x1F\x02\xA5\xAF\x05> \x02\xA6\xAF\x05D#\x02\xA7\xAF\x05H%\x02\xA8" +
		"\xA9\x07\x18\x02\x02\xA9\xAF\x05\x18\r\x05\xAA\xAB\x07\x17\x02\x02\xAB" +
		"\xAF\x05\x18\r\x04\xAC\xAD\x07$\x02\x02\xAD\xAF\x05\x1C\x0F\x02\xAE\x96" +
		"\x03\x02\x02\x02\xAE\x98\x03\x02\x02\x02\xAE\x99\x03\x02\x02\x02\xAE\x9A" +
		"\x03\x02\x02\x02\xAE\x9B\x03\x02\x02\x02\xAE\x9C\x03\x02\x02\x02\xAE\x9D" +
		"\x03\x02\x02\x02\xAE\x9E\x03\x02\x02\x02\xAE\x9F\x03\x02\x02\x02\xAE\xA3" +
		"\x03\x02\x02\x02\xAE\xA4\x03\x02\x02\x02\xAE\xA5\x03\x02\x02\x02\xAE\xA6" +
		"\x03\x02\x02\x02\xAE\xA7\x03\x02\x02\x02\xAE\xA8\x03\x02\x02\x02\xAE\xAA" +
		"\x03\x02\x02\x02\xAE\xAC\x03\x02\x02\x02\xAF\xF1\x03\x02\x02\x02\xB0\xB1" +
		"\f\x1A\x02\x02\xB1\xB2\x07\x15\x02\x02\xB2\xF0\x05\x18\r\x1B\xB3\xB4\f" +
		"\x19\x02\x02\xB4\xB5\x07\x16\x02\x02\xB5\xF0\x05\x18\r\x1A\xB6\xB7\f\x18" +
		"\x02\x02\xB7\xB8\x07\x19\x02\x02\xB8\xF0\x05\x18\r\x19\xB9\xBA\f\x17\x02" +
		"\x02\xBA\xBB\x07\x17\x02\x02\xBB\xF0\x05\x18\r\x18\xBC\xBD\f\x16\x02\x02" +
		"\xBD\xBE\x07\x18\x02\x02\xBE\xF0\x05\x18\r\x17\xBF\xC0\f\x15\x02\x02\xC0" +
		"\xC1\x07*\x02\x02\xC1\xF0\x05\x18\r\x16\xC2\xC3\f\x14\x02\x02\xC3\xC4" +
		"\x07)\x02\x02\xC4\xF0\x05\x18\r\x15\xC5\xC6\f\x13\x02\x02\xC6\xC7\x07" +
		"\x1C\x02\x02\xC7\xF0\x05\x18\r\x14\xC8\xC9\f\x12\x02\x02\xC9\xCA\x07\x1A" +
		"\x02\x02\xCA\xF0\x05\x18\r\x13\xCB\xCC\f\x11\x02\x02\xCC\xCD\x07\x1D\x02" +
		"\x02\xCD\xF0\x05\x18\r\x12\xCE\xCF\f\x10\x02\x02\xCF\xD0\x07\x1B\x02\x02" +
		"\xD0\xF0\x05\x18\r\x11\xD1\xD2\f\x0F\x02\x02\xD2\xD3\x07\x1F\x02\x02\xD3" +
		"\xF0\x05\x18\r\x10\xD4\xD5\f\x0E\x02\x02\xD5\xD6\x07 \x02\x02\xD6\xF0" +
		"\x05\x18\r\x0F\xD7\xD8\f\r\x02\x02\xD8\xD9\x07#\x02\x02\xD9\xF0\x05\x18" +
		"\r\x0E\xDA\xDB\f\f\x02\x02\xDB\xDC\x07\"\x02\x02\xDC\xF0\x05\x18\r\r\xDD" +
		"\xDE\f\v\x02\x02\xDE\xDF\x07%\x02\x02\xDF\xF0\x05\x18\r\f\xE0\xE1\f\n" +
		"\x02\x02\xE1\xE2\x07&\x02\x02\xE2\xF0\x05\x18\r\v\xE3\xE4\f\t\x02\x02" +
		"\xE4\xE5\x07!\x02\x02\xE5\xF0\x05\x18\r\n\xE6\xE7\f\b\x02\x02\xE7\xE8" +
		"\x07\x1E\x02\x02\xE8\xF0\x05\x18\r\t\xE9\xEA\f\x07\x02\x02\xEA\xEB\x07" +
		"\'\x02\x02\xEB\xF0\x05\x18\r\b\xEC\xED\f\x06\x02\x02\xED\xEE\x07(\x02" +
		"\x02\xEE\xF0\x05\x18\r\x07\xEF\xB0\x03\x02\x02\x02\xEF\xB3\x03\x02\x02" +
		"\x02\xEF\xB6\x03\x02\x02\x02\xEF\xB9\x03\x02\x02\x02\xEF\xBC\x03\x02\x02" +
		"\x02\xEF\xBF\x03\x02\x02\x02\xEF\xC2\x03\x02\x02\x02\xEF\xC5\x03\x02\x02" +
		"\x02\xEF\xC8\x03\x02\x02\x02\xEF\xCB\x03\x02\x02\x02\xEF\xCE\x03\x02\x02" +
		"\x02\xEF\xD1\x03\x02\x02\x02\xEF\xD4\x03\x02\x02\x02\xEF\xD7\x03\x02\x02" +
		"\x02\xEF\xDA\x03\x02\x02\x02\xEF\xDD\x03\x02\x02\x02\xEF\xE0\x03\x02\x02" +
		"\x02\xEF\xE3\x03\x02\x02\x02\xEF\xE6\x03\x02\x02\x02\xEF\xE9\x03\x02\x02" +
		"\x02\xEF\xEC\x03\x02\x02\x02\xF0\xF3\x03\x02\x02\x02\xF1\xEF\x03\x02\x02" +
		"\x02\xF1\xF2\x03\x02\x02\x02\xF2\x19\x03\x02\x02\x02\xF3\xF1\x03\x02\x02" +
		"\x02\xF4\xF6\x05\x16\f\x02\xF5\xF4\x03\x02\x02\x02\xF6\xF9\x03\x02\x02" +
		"\x02\xF7\xF5\x03\x02\x02\x02\xF7\xF8\x03\x02\x02\x02\xF8\x1B\x03\x02\x02" +
		"\x02\xF9\xF7\x03\x02\x02\x02\xFA\xFB\x07\x05\x02\x02\xFB\xFC\x05\x18\r" +
		"\x02\xFC\xFD\x07\x06\x02\x02\xFD\x1D\x03\x02\x02\x02\xFE\xFF\x07/\x02" +
		"\x02\xFF\u0100\t\x02\x02\x02\u0100\x1F\x03\x02\x02\x02\u0101\u0102\x05" +
		"\"\x12\x02\u0102\u0103\x07\x07\x02\x02\u0103!\x03\x02\x02\x02\u0104\u010A" +
		"\x05\x18\r\x02\u0105\u0106\x07\b\x02\x02\u0106\u0107\x05\x18\r\x02\u0107" +
		"\u0108\x07\t\x02\x02\u0108\u0109\x05\"\x12\x02\u0109\u010B\x03\x02\x02" +
		"\x02\u010A\u0105\x03\x02\x02\x02\u010A\u010B\x03\x02\x02\x02\u010B#\x03" +
		"\x02\x02\x02\u010C\u010E\x07\n\x02\x02\u010D\u010F\x05\x18\r\x02\u010E" +
		"\u010D\x03\x02\x02\x02\u010E\u010F\x03\x02\x02\x02\u010F\u0110\x03\x02" +
		"\x02\x02\u0110\u0111\x07\x07\x02\x02\u0111%\x03\x02\x02\x02\u0112\u0113" +
		"\x05\x18\r\x02\u0113\u0114\x07\x07\x02\x02\u0114\'\x03\x02\x02\x02\u0115" +
		"\u0116\x07\v\x02\x02\u0116\u0117\x07\x05\x02\x02\u0117\u0118\x05\x18\r" +
		"\x02\u0118\u0119\x07\x06\x02\x02\u0119\u011A\x07\f\x02\x02\u011A\u011B" +
		"\x05\x1A\x0E\x02\u011B\u0124\x07\r\x02\x02\u011C\u0122\x07\x0E\x02\x02" +
		"\u011D\u011E\x07\f\x02\x02\u011E\u011F\x05\x1A\x0E\x02\u011F\u0120\x07" +
		"\r\x02\x02\u0120\u0123\x03\x02\x02\x02\u0121\u0123\x05(\x15\x02\u0122" +
		"\u011D\x03\x02\x02\x02\u0122\u0121\x03\x02\x02\x02\u0123\u0125\x03\x02" +
		"\x02\x02\u0124\u011C\x03\x02\x02\x02\u0124\u0125\x03\x02\x02\x02\u0125" +
		")\x03\x02\x02\x02\u0126\u012A\x05,\x17\x02\u0127\u012A\x05.\x18\x02\u0128" +
		"\u012A\x050\x19\x02\u0129\u0126\x03\x02\x02\x02\u0129\u0127\x03\x02\x02" +
		"\x02\u0129\u0128\x03\x02\x02\x02\u012A+\x03\x02\x02\x02\u012B\u012C\x07" +
		"\x0F\x02\x02\u012C\u012D\x07\x05\x02\x02\u012D\u012E\x05\x18\r\x02\u012E" +
		"\u012F\x07\x06\x02\x02\u012F\u0130\x07\f\x02\x02\u0130\u0131\x05\x1A\x0E" +
		"\x02\u0131\u0132\x07\r\x02\x02\u0132-\x03\x02\x02\x02\u0133\u0134\x07" +
		"\x10\x02\x02\u0134\u0135\x07\f\x02\x02\u0135\u0136\x05\x1A\x0E\x02\u0136" +
		"\u0137\x07\r\x02\x02\u0137\u0138\x07\x0F\x02\x02\u0138\u0139\x07\x05\x02" +
		"\x02\u0139\u013A\x05\x18\r\x02\u013A\u013B\x07\x06\x02\x02\u013B\u013C" +
		"\x07\x07\x02\x02\u013C/\x03\x02\x02\x02\u013D\u013E\x07\x11\x02\x02\u013E" +
		"\u013F\x07\x05\x02\x02\u013F\u0140\x052\x1A\x02\u0140\u0141\x07\x06\x02" +
		"\x02\u0141\u0142\x07\f\x02\x02\u0142\u0143\x05\x1A\x0E\x02\u0143\u0144" +
		"\x07\r\x02\x02\u01441\x03\x02\x02\x02\u0145\u0146\x05\x18\r\x02\u0146" +
		"\u0148\x07\x07\x02\x02\u0147\u0149\x05\x18\r\x02\u0148\u0147\x03\x02\x02" +
		"\x02\u0148\u0149\x03\x02\x02\x02\u0149\u014A\x03\x02\x02\x02\u014A\u014B" +
		"\x07\x07\x02\x02\u014B\u014C\x05\x18\r\x02\u014C3\x03\x02\x02\x02\u014D" +
		"\u014E\x05\n\x06\x02\u014E\u014F\x07/\x02\x02\u014F\u0151\x07\x12\x02" +
		"\x02\u0150\u0152\x071\x02\x02\u0151\u0150\x03\x02\x02\x02\u0151\u0152" +
		"\x03\x02\x02\x02\u0152\u0153\x03\x02\x02\x02\u0153\u0154\x07\x13\x02\x02" +
		"\u01545\x03\x02\x02\x02\u0155\u0159\x07\f\x02\x02\u0156\u015A\x05\x14" +
		"\v\x02\u0157\u015A\x05\x12\n\x02\u0158\u015A\x05\x0E\b\x02\u0159\u0156" +
		"\x03\x02\x02\x02\u0159\u0157\x03\x02\x02\x02\u0159\u0158\x03\x02\x02\x02" +
		"\u015A\u015B\x03\x02\x02\x02\u015B\u015C\x07\r\x02\x02\u015C7\x03\x02" +
		"\x02\x02\u015D\u0161\x054\x1B\x02\u015E\u015F\x07\x1E\x02\x02\u015F\u0162" +
		"\x056\x1C\x02\u0160\u0162\x05\x04\x03\x02\u0161\u015E\x03\x02\x02\x02" +
		"\u0161\u0160\x03\x02\x02\x02\u0161\u0162\x03\x02\x02\x02\u01629\x03\x02" +
		"\x02\x02\u0163\u0164\x05\n\x06\x02\u0164\u0165\x07\x15\x02\x02\u0165\u0166" +
		"\x07/\x02\x02\u0166;\x03\x02\x02\x02\u0167\u0168\x07\x15\x02\x02\u0168" +
		"\u0169\x07/\x02\x02\u0169=\x03\x02\x02\x02\u016A\u016B\x07%\x02\x02\u016B" +
		"\u016C\x07/\x02\x02\u016C?\x03\x02\x02\x02\u016D\u016E\x05B\"\x02\u016E" +
		"A\x03\x02\x02\x02\u016F\u0170\x05\n\x06\x02\u0170\u0171\x07/\x02\x02\u0171" +
		"\u0173\x07\x05\x02\x02\u0172\u0174\x05\f\x07\x02\u0173\u0172\x03\x02\x02" +
		"\x02\u0173\u0174\x03\x02\x02\x02\u0174\u0175\x03\x02\x02\x02\u0175\u0176" +
		"\x07\x06\x02\x02\u0176\u0177\x03\x02\x02\x02\u0177\u0178\x07\f\x02\x02" +
		"\u0178\u0179\x05\x1A\x0E\x02\u0179\u017A\x07\r\x02\x02\u017AC\x03\x02" +
		"\x02\x02\u017B\u017C\x07/\x02\x02\u017C\u017D\x07\x05\x02\x02\u017D\u017E" +
		"\x05F$\x02\u017E\u017F\x07\x06\x02\x02\u017FE\x03\x02\x02\x02\u0180\u0181" +
		"\x05\x10\t\x02\u0181G\x03\x02\x02\x02\u0182\u0187\x07\x14\x02\x02\u0183" +
		"\u0186\x05\x04\x03\x02\u0184\u0186\x070\x02\x02\u0185\u0183\x03\x02\x02" +
		"\x02\u0185\u0184\x03\x02\x02\x02\u0186\u0189\x03\x02\x02\x02\u0187\u0185" +
		"\x03\x02\x02\x02\u0187\u0188\x03\x02\x02\x02\u0188\u018A\x03\x02\x02\x02" +
		"\u0189\u0187\x03\x02\x02\x02\u018A\u018B\x07\x04\x02\x02\u018B\u018C\x05" +
		"\x0E\b\x02\u018C\u018D\x07\x06\x02\x02\u018DI\x03\x02\x02\x02\x1CMR[b" +
		"ks{\x83\x8B\x94\xAE\xEF\xF1\xF7\u010A\u010E\u0122\u0124\u0129\u0148\u0151" +
		"\u0159\u0161\u0173\u0185\u0187";
...
export class StatementContext extends ParserRuleContext {
	...
	public condExpressionStatement(): CondExpressionStatementContext | undefined {
		return this.tryGetRuleContext(0, CondExpressionStatementContext);
	}
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
...
export class CondExpressionStatementContext extends ParserRuleContext {
	public _conditionalExpression!: CondExpressionContext;
	public condExpression(): CondExpressionContext {
		return this.getRuleContext(0, CondExpressionContext);
	}
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return ClangParser.RULE_condExpressionStatement; }
	// @Override
	public enterRule(listener: ClangListener): void {
		if (listener.enterCondExpressionStatement) {
			listener.enterCondExpressionStatement(this);
		}
	}
	// @Override
	public exitRule(listener: ClangListener): void {
		if (listener.exitCondExpressionStatement) {
			listener.exitCondExpressionStatement(this);
		}
	}
	// @Override
	public accept<Result>(visitor: ClangVisitor<Result>): Result {
		if (visitor.visitCondExpressionStatement) {
			return visitor.visitCondExpressionStatement(this);
		} else {
			return visitor.visitChildren(this);
		}
	}
...
export class CondExpressionContext extends ParserRuleContext {
	public _test!: ExpressionContext;
	public _consequent!: ExpressionContext;
	public _alternate!: CondExpressionContext;
	public expression(): ExpressionContext[];
	public expression(i: number): ExpressionContext;
	public expression(i?: number): ExpressionContext | ExpressionContext[] {
		if (i === undefined) {
	...
	public condExpression(): CondExpressionContext | undefined {
		return this.tryGetRuleContext(0, CondExpressionContext);
	}
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return ClangParser.RULE_condExpression; }
	// @Override
	public enterRule(listener: ClangListener): void {
