...
export class ClangParser extends Parser {
	...
	public static readonly ruleNames: string[] = [
		"start", "identifierWithType", "identifierWithTypeList", "identifierList", 
		"numberList", "statement", "expression", "parenthesesExpression", "postFixExpression", 
		"conditionalExpression", "expressionStatement", "selectionStatement", 
	...
	public start(): StartContext {
		...
		try {
			...
			while ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << ClangParser.T__1) | (1 << ClangParser.T__3) | (1 << ClangParser.T__5) | (1 << ClangParser.T__20) | (1 << ClangParser.T__29))) !== 0) || ((((_la - 32)) & ~0x1F) === 0 && ((1 << (_la - 32)) & ((1 << (ClangParser.T__31 - 32)) | (1 << (ClangParser.T__32 - 32)) | (1 << (ClangParser.T__33 - 32)) | (1 << (ClangParser.PRIMITIVETYPE - 32)) | (1 << (ClangParser.IDENTIFIER - 32)) | (1 << (ClangParser.NUMBER - 32)) | (1 << (ClangParser.StringLiteral - 32)))) !== 0)) {
				{
				{
				this.state = 44;
				this.statement();
	...
	public statement(): StatementContext {
		...
		try {
			...
			case 1:
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
				if ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << ClangParser.T__1) | (1 << ClangParser.T__3) | (1 << ClangParser.T__5) | (1 << ClangParser.T__20) | (1 << ClangParser.T__29))) !== 0) || ((((_la - 32)) & ~0x1F) === 0 && ((1 << (_la - 32)) & ((1 << (ClangParser.T__31 - 32)) | (1 << (ClangParser.T__32 - 32)) | (1 << (ClangParser.T__33 - 32)) | (1 << (ClangParser.PRIMITIVETYPE - 32)) | (1 << (ClangParser.IDENTIFIER - 32)) | (1 << (ClangParser.NUMBER - 32)) | (1 << (ClangParser.StringLiteral - 32)))) !== 0)) {
					{
					this.state = 79;
					this._errHandler.sync(this);
					_la = this._input.LA(1);
	...
	public forCondition(): ForConditionContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << ClangParser.T__3) | (1 << ClangParser.T__5) | (1 << ClangParser.T__20))) !== 0) || ((((_la - 39)) & ~0x1F) === 0 && ((1 << (_la - 39)) & ((1 << (ClangParser.PRIMITIVETYPE - 39)) | (1 << (ClangParser.IDENTIFIER - 39)) | (1 << (ClangParser.NUMBER - 39)) | (1 << (ClangParser.StringLiteral - 39)))) !== 0)) {
				{
				this.state = 230;
...
export class ExpressionContext extends ParserRuleContext {
	...
	public StringLiteral(): TerminalNode | undefined { return this.tryGetToken(ClangParser.StringLiteral, 0); }
