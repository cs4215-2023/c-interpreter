...
export class ClangParser extends Parser {
	...
	public static readonly ruleNames: string[] = [
		"start", "type", "expression", "statement", "parenthesesExpression", "conditionalExpression", 
	...
	private static readonly _SYMBOLIC_NAMES: Array<string | undefined> = [
		...
		undefined, undefined, undefined, undefined, undefined, undefined, undefined, 
		undefined, undefined, undefined, undefined, undefined, undefined, undefined, 
		undefined, undefined, undefined, undefined, "SIMPLEESCAPESEQUENCE", "StringLiteral", 
	...
	public start(): StartContext {
		...
		try {
			...
			while ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << ClangParser.T__6) | (1 << ClangParser.StringLiteral) | (1 << ClangParser.IDENTIFIER))) !== 0)) {
				{
				{
				this.state = 20;
				this.expression(0);
	...
	public statement(): StatementContext {
		...
		try {
			...
			case ClangParser.T__14:
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
				if ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << ClangParser.T__6) | (1 << ClangParser.T__14) | (1 << ClangParser.T__19) | (1 << ClangParser.T__21) | (1 << ClangParser.T__22) | (1 << ClangParser.T__23) | (1 << ClangParser.StringLiteral) | (1 << ClangParser.IDENTIFIER))) !== 0)) {
					{
					this.state = 63;
					this._errHandler.sync(this);
					_la = this._input.LA(1);
					do {
						...
						this._errHandler.sync(this);
						_la = this._input.LA(1);
					} while ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << ClangParser.T__6) | (1 << ClangParser.T__14) | (1 << ClangParser.T__19) | (1 << ClangParser.T__21) | (1 << ClangParser.T__22) | (1 << ClangParser.T__23) | (1 << ClangParser.StringLiteral) | (1 << ClangParser.IDENTIFIER))) !== 0));
					}
				}
