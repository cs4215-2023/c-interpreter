...
export class ClangParser extends Parser {
	...
	public static readonly ruleNames: string[] = [
		...
		"expression", "parenthesesExpression", "statementList", "postFix", "conditionalExpression", 
		"expressionStatement", "conditionalStatement", "iterationStatement", "forCondition", 
		"arrayIdentifierWithType", "arrayContent", "arrayInitialisation", "pointer", 
		"pointerDerefernce", "pointerReference", "function", "functionCall", "functionCallParameters", 
		"printf",
	];
	...
	public start(): StartContext {
		...
		try {
			...
			while ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << ClangParser.T__0) | (1 << ClangParser.T__2) | (1 << ClangParser.T__9) | (1 << ClangParser.T__11) | (1 << ClangParser.T__12) | (1 << ClangParser.T__13) | (1 << ClangParser.T__16) | (1 << ClangParser.MUL) | (1 << ClangParser.ADD) | (1 << ClangParser.SUB))) !== 0) || ((((_la - 33)) & ~0x1F) === 0 && ((1 << (_la - 33)) & ((1 << (ClangParser.NOT - 33)) | (1 << (ClangParser.BITWISEAND - 33)) | (1 << (ClangParser.PRIMITIVETYPE - 33)) | (1 << (ClangParser.SIGNEDTYPE - 33)) | (1 << (ClangParser.IDENTIFIER - 33)) | (1 << (ClangParser.NUMBER - 33)))) !== 0)) {
				{
				{
				this.state = 56;
				this.statement();
	...
	public statementList(): StatementListContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << ClangParser.T__0) | (1 << ClangParser.T__2) | (1 << ClangParser.T__9) | (1 << ClangParser.T__11) | (1 << ClangParser.T__12) | (1 << ClangParser.T__13) | (1 << ClangParser.T__16) | (1 << ClangParser.MUL) | (1 << ClangParser.ADD) | (1 << ClangParser.SUB))) !== 0) || ((((_la - 33)) & ~0x1F) === 0 && ((1 << (_la - 33)) & ((1 << (ClangParser.NOT - 33)) | (1 << (ClangParser.BITWISEAND - 33)) | (1 << (ClangParser.PRIMITIVETYPE - 33)) | (1 << (ClangParser.SIGNEDTYPE - 33)) | (1 << (ClangParser.IDENTIFIER - 33)) | (1 << (ClangParser.NUMBER - 33)))) !== 0)) {
				{
				this.state = 214;
				this._errHandler.sync(this);
				_la = this._input.LA(1);
	...
	public static readonly _serializedATN: string =
		...
		"\x13\x03\x14\x03\x14\x03\x14\x03\x14\x05\x14\u0118\n\x14\x03\x14\x03\x14" +
		"\x03\x15\x03\x15\x03\x15\x05\x15\u011F\n\x15\x03\x15\x03\x15\x03\x16\x03" +
		"\x16\x03\x16\x03\x16\x05\x16\u0127\n\x16\x03\x17\x03\x17\x03\x17\x03\x17" +
		"\x03\x18\x03\x18\x03\x18\x03\x19\x03\x19\x03\x19\x03\x1A\x03\x1A\x03\x1A" +
		"\x03\x1A\x05\x1A\u0137\n\x1A\x03\x1A\x03\x1A\x03\x1A\x03\x1A\x03\x1B\x03" +
		"\x1B\x03\x1B\x03\x1B\x03\x1B\x03\x1C\x03\x1C\x03\x1C\x05\x1C\u0145\n\x1C" +
		"\x03\x1C\x03\x1C\x03\x1C\x03\x1C\x07\x1C\u014B\n\x1C\f\x1C\x0E\x1C\u014E" +
		"\v\x1C\x03\x1D\x03\x1D\x03\x1D\x07\x1D\u0153\n\x1D\f\x1D\x0E\x1D\u0156" +
		"\v\x1D\x03\x1D\x03\x1D\x03\x1D\x03\x1D\x03\x1D\x02\x02\x03\x14\x1E\x02" +
		"\x02\x04\x02\x06\x02\b\x02\n\x02\f\x02\x0E\x02\x10\x02\x12\x02\x14\x02" +
		"\x16\x02\x18\x02\x1A\x02\x1C\x02\x1E\x02 \x02\"\x02$\x02&\x02(\x02*\x02" +
		",\x02.\x020\x022\x024\x026\x028\x02\x02\x03\x03\x0234\x02\u017E\x02=\x03" +
		"\x02\x02\x02\x04B\x03\x02\x02\x02\x06H\x03\x02\x02\x02\bP\x03\x02\x02" +
		"\x02\nT\x03\x02\x02\x02\fX\x03\x02\x02\x02\x0E`\x03\x02\x02\x02\x10h\x03" +
		"\x02\x02\x02\x12t\x03\x02\x02\x02\x14\x8C\x03\x02\x02\x02\x16\xD2\x03" +
		"\x02\x02\x02\x18\xD6\x03\x02\x02\x02\x1A\xE0\x03\x02\x02\x02\x1C\xE3\x03" +
		"\x02\x02\x02\x1E\xE9\x03\x02\x02\x02 \xEC\x03\x02\x02\x02\"\u0109\x03" +
		"\x02\x02\x02$\u010B\x03\x02\x02\x02&\u0113\x03\x02\x02\x02(\u011B\x03" +
		"\x02\x02\x02*\u0122\x03\x02\x02\x02,\u0128\x03\x02\x02\x02.\u012C\x03" +
		"\x02\x02\x020\u012F\x03\x02\x02\x022\u0132\x03\x02\x02\x024\u013C\x03" +
		"\x02\x02\x026\u0144\x03\x02\x02\x028\u014F\x03\x02\x02\x02:<\x05\x12\n" +
		"\x02;:\x03\x02\x02\x02<?\x03\x02\x02\x02=;\x03\x02\x02\x02=>\x03\x02\x02" +
		"\x02>@\x03\x02\x02\x02?=\x03\x02\x02\x02@A\x07\x02\x02\x03A\x03\x03\x02" +
		"\x02\x02BD\x07\x03\x02\x02CE\x07.\x02\x02DC\x03\x02\x02\x02DE\x03\x02" +
		"\x02\x02EF\x03\x02\x02\x02FG\x07\x03\x02\x02G\x05\x03\x02\x02\x02HM\x05" +
		"\x04\x03\x02IJ\x07\x04\x02\x02JL\x05\x04\x03\x02KI\x03\x02\x02\x02LO\x03" +
		"\x02\x02\x02MK\x03\x02\x02\x02MN\x03\x02\x02\x02N\x07\x03\x02\x02\x02" +
		"OM\x03\x02\x02\x02PQ\x05\n\x06\x02QR\x07.\x02\x02R\t\x03\x02\x02\x02S" +
		"U\x07-\x02\x02TS\x03\x02\x02\x02TU\x03\x02\x02\x02UV\x03\x02\x02\x02V" +
		"W\x07,\x02\x02W\v\x03\x02\x02\x02X]\x05\b\x05\x02YZ\x07\x04\x02\x02Z\\" +
		...
		"\u0117\x07\x11\x02\x02\u0116\u0118\x070\x02\x02\u0117\u0116\x03\x02\x02" +
		"\x02\u0117\u0118\x03\x02\x02\x02\u0118\u0119\x03\x02\x02\x02\u0119\u011A" +
		"\x07\x12\x02\x02\u011A\'\x03\x02\x02\x02\u011B\u011E\x07\x07\x02\x02\u011C" +
		"\u011F\x05\x0E\b\x02\u011D\u011F\x05\x10\t\x02\u011E\u011C\x03\x02\x02" +
		"\x02\u011E\u011D\x03\x02\x02\x02\u011F\u0120\x03\x02\x02\x02\u0120\u0121" +
		"\x07\b\x02\x02\u0121)\x03\x02\x02\x02\u0122\u0126\x05&\x14\x02\u0123\u0124" +
		"\x07\x1D\x02\x02\u0124\u0127\x05(\x15\x02\u0125\u0127\x05\x04\x03\x02" +
		"\u0126\u0123\x03\x02\x02\x02\u0126\u0125\x03\x02\x02\x02\u0126\u0127\x03" +
		"\x02\x02\x02\u0127+\x03\x02\x02\x02\u0128\u0129\x07,\x02\x02\u0129\u012A" +
		"\x07\x14\x02\x02\u012A\u012B\x07.\x02\x02\u012B-\x03\x02\x02\x02\u012C" +
		"\u012D\x07\x14\x02\x02\u012D\u012E\x07.\x02\x02\u012E/\x03\x02\x02\x02" +
		"\u012F\u0130\x07$\x02\x02\u0130\u0131\x07.\x02\x02\u01311\x03\x02\x02" +
		"\x02\u0132\u0133\x07,\x02\x02\u0133\u0134\x07.\x02\x02\u0134\u0136\x07" +
		"\x05\x02\x02\u0135\u0137\x05\f\x07\x02\u0136\u0135\x03\x02\x02\x02\u0136" +
		"\u0137\x03\x02\x02\x02\u0137\u0138\x03\x02\x02\x02\u0138\u0139\x07\x06" +
		"\x02\x02\u0139\u013A\x03\x02\x02\x02\u013A\u013B\x05\x18\r\x02\u013B3" +
		"\x03\x02\x02\x02\u013C\u013D\x07.\x02\x02\u013D\u013E\x07\x05\x02\x02" +
		"\u013E\u013F\x056\x1C\x02\u013F\u0140\x07\x06\x02\x02\u01405\x03\x02\x02" +
		"\x02\u0141\u0145\x05\x06\x04\x02\u0142\u0145\x05\x10\t\x02\u0143\u0145" +
		"\x05\x0E\b\x02\u0144\u0141\x03\x02\x02\x02\u0144\u0142\x03\x02\x02\x02" +
		"\u0144\u0143\x03\x02\x02\x02\u0145\u014C\x03\x02\x02\x02\u0146\u0147\x07" +
		"\x04\x02\x02\u0147\u014B\x05\x06\x04\x02\u0148\u014B\x05\x10\t\x02\u0149" +
		"\u014B\x05\x0E\b\x02\u014A\u0146\x03\x02\x02\x02\u014A\u0148\x03\x02\x02" +
		"\x02\u014A\u0149\x03\x02\x02\x02\u014B\u014E\x03\x02\x02\x02\u014C\u014A" +
		"\x03\x02\x02\x02\u014C\u014D\x03\x02\x02\x02\u014D7\x03\x02\x02\x02\u014E" +
		"\u014C\x03\x02\x02\x02\u014F\u0154\x07\x13\x02\x02\u0150\u0153\x05\x04" +
		"\x03\x02\u0151\u0153\x07/\x02\x02\u0152\u0150\x03\x02\x02\x02\u0152\u0151" +
		"\x03\x02\x02\x02\u0153\u0156\x03\x02\x02\x02\u0154\u0152\x03\x02\x02\x02" +
		"\u0154\u0155\x03\x02\x02\x02\u0155\u0157\x03\x02\x02\x02\u0156\u0154\x03" +
		"\x02\x02\x02\u0157\u0158\x07\x04\x02\x02\u0158\u0159\x05\x0E\b\x02\u0159" +
		"\u015A\x07\x06\x02\x02\u015A9\x03\x02\x02\x02\x1B=DMT]emt\x8C\xCD\xCF" +
		"\xDA\xDC\xF3\u0109\u010E\u0117\u011E\u0126\u0136\u0144\u014A\u014C\u0152" +
		"\u0154";
