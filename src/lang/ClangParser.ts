...
export class ClangParser extends Parser {
  ...
  public condExpressionStatement(): CondExpressionStatementContext {
    const _localctx: CondExpressionStatementContext = new CondExpressionStatementContext(
      this._ctx,
      this.state
    )
  ...
  public condExpression(): CondExpressionContext {
    const _localctx: CondExpressionContext = new CondExpressionContext(this._ctx, this.state)
...
export class CondExpressionStatementContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return ClangParser.RULE_condExpressionStatement
  }
  // @Override
  public enterRule(listener: ClangListener): void {
...
export class CondExpressionContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return ClangParser.RULE_condExpression
  }
  // @Override
  public enterRule(listener: ClangListener): void {
