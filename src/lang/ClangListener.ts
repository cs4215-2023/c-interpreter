...
import { CondExpressionStatementContext } from './ClangParser'
import { CondExpressionContext } from './ClangParser'
...
export interface ClangListener extends ParseTreeListener {
  ...
  /**
   * Enter a parse tree produced by `ClangParser.condExpressionStatement`.
   * @param ctx the parse tree
   */
  enterCondExpressionStatement?: (ctx: CondExpressionStatementContext) => void
  /**
   * Exit a parse tree produced by `ClangParser.condExpressionStatement`.
   * @param ctx the parse tree
   */
  exitCondExpressionStatement?: (ctx: CondExpressionStatementContext) => void

  /**
   * Enter a parse tree produced by `ClangParser.condExpression`.
   * @param ctx the parse tree
   */
  enterCondExpression?: (ctx: CondExpressionContext) => void
  /**
   * Exit a parse tree produced by `ClangParser.condExpression`.
   * @param ctx the parse tree
   */
