...
import { IdentifierDeclarationExpressionContext } from "./ClangParser";
...
export interface ClangListener extends ParseTreeListener {
	/**
	 * Enter a parse tree produced by the `IdentifierDeclarationExpression`
	 * labeled alternative in `ClangParser.expression`.
	 * @param ctx the parse tree
	 */
	enterIdentifierDeclarationExpression?: (ctx: IdentifierDeclarationExpressionContext) => void;
	/**
	 * Exit a parse tree produced by the `IdentifierDeclarationExpression`
	 * labeled alternative in `ClangParser.expression`.
	 * @param ctx the parse tree
	 */
	exitIdentifierDeclarationExpression?: (ctx: IdentifierDeclarationExpressionContext) => void;
