    ...
    try {
      this.enterOuterAlt(_localctx, 1)
      {
        ...
        while (
          ...
          (((_la - 33) & ~0x1f) === 0 &&
            ((1 << (_la - 33)) &
              ((1 << (CParser.PlusPlus - 33)) |
                (1 << (CParser.MinusMinus - 33)) |
                (1 << (CParser.Arrow - 33)) |
                (1 << (CParser.Dot - 33)))) !==
              0)
        ) {
              ...
              case CParser.LeftParen:
                {
                  ...
                  if (
                    ...
                    (((_la - 65) & ~0x1f) === 0 &&
                      ((1 << (_la - 65)) &
                        ((1 << (CParser.Identifier - 65)) |
                          (1 << (CParser.Constant - 65)) |
                          (1 << (CParser.DigitSequence - 65)) |
                          (1 << (CParser.StringLiteral - 65)))) !==
                        0)
                  ) {
                    {
                      this.state = 157
      ...
      this.enterOuterAlt(_localctx, 1)
      {
        ...
        if (
          !(
            ...
            ((1 << (_la - 50)) &
              ((1 << (CParser.Assign - 50)) |
                (1 << (CParser.StarAssign - 50)) |
                (1 << (CParser.DivAssign - 50)) |
                (1 << (CParser.ModAssign - 50)) |
                (1 << (CParser.PlusAssign - 50)) |
                (1 << (CParser.MinusAssign - 50)) |
                (1 << (CParser.LeftShiftAssign - 50)) |
                (1 << (CParser.RightShiftAssign - 50)) |
                (1 << (CParser.AndAssign - 50)) |
                (1 << (CParser.XorAssign - 50)) |
                (1 << (CParser.OrAssign - 50)))) !==
              0
          )
        ) {
          this._errHandler.recoverInline(this)
          ...
          ((_la & ~0x1f) === 0 &&
            ((1 << _la) &
              ((1 << CParser.T__0) |
                ...
                (1 << CParser.LeftBrace) |
                (1 << CParser.RightBrace) |
                (1 << CParser.Less) |
                (1 << CParser.LessEqual) |
                (1 << CParser.Greater) |
                (1 << CParser.GreaterEqual) |
                (1 << CParser.LeftShift) |
                (1 << CParser.RightShift))) !==
              0) ||
          (((_la - 32) & ~0x1f) === 0 &&
            ((1 << (_la - 32)) &
              ((1 << (CParser.Plus - 32)) |
                ...
                (1 << (CParser.Not - 32)) |
                (1 << (CParser.Tilde - 32)) |
                (1 << (CParser.Question - 32)) |
                (1 << (CParser.Colon - 32)) |
                (1 << (CParser.Semi - 32)) |
                (1 << (CParser.Comma - 32)) |
                (1 << (CParser.Assign - 32)) |
                (1 << (CParser.StarAssign - 32)) |
                (1 << (CParser.DivAssign - 32)) |
                (1 << (CParser.ModAssign - 32)) |
                (1 << (CParser.PlusAssign - 32)) |
                (1 << (CParser.MinusAssign - 32)) |
                (1 << (CParser.LeftShiftAssign - 32)) |
                (1 << (CParser.RightShiftAssign - 32)) |
                (1 << (CParser.AndAssign - 32)) |
                (1 << (CParser.XorAssign - 32)) |
                (1 << (CParser.OrAssign - 32)) |
                (1 << (CParser.Equal - 32)) |
                (1 << (CParser.NotEqual - 32)) |
                (1 << (CParser.Arrow - 32)))) !==
              0) ||
          (((_la - 64) & ~0x1f) === 0 &&
            ((1 << (_la - 64)) &
              ((1 << (CParser.Dot - 64)) |
                (1 << (CParser.Identifier - 64)) |
                (1 << (CParser.Constant - 64)) |
                (1 << (CParser.DigitSequence - 64)) |
                (1 << (CParser.StringLiteral - 64)) |
                (1 << (CParser.Whitespace - 64)) |
                (1 << (CParser.Newline - 64)) |
                (1 << (CParser.BlockComment - 64)) |
                (1 << (CParser.LineComment - 64)))) !==
              0)
        ) {
          {
            this.state = 456
        ...
        case 2:
          this.enterOuterAlt(_localctx, 2)
          {
            ...
            if (
              ((_la - 20) & ~0x1f) === 0 &&
              ((1 << (_la - 20)) &
                ((1 << (CParser.LeftParen - 20)) |
                  (1 << (CParser.LeftBracket - 20)) |
                  (1 << (CParser.Star - 20)) |
                  (1 << (CParser.Caret - 20)))) !==
                0
            ) {
