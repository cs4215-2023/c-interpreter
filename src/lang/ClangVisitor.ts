...
export interface ClangVisitor<Result> extends ParseTreeVisitor<Result> {
  /**
   * Visit a parse tree produced by the `IdentifierDeclarationExpression`
   * labeled alternative in `ClangParser.expression`.
   * @param ctx the parse tree
   * @return the visitor result
   */
  visitIdentifierDeclarationExpression?: (ctx: IdentifierDeclarationExpressionContext) => Result
