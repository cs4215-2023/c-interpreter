...
export interface ClangVisitor<Result> extends ParseTreeVisitor<Result> {
  ...
  /**
   * Visit a parse tree produced by `ClangParser.condExpressionStatement`.
   * @param ctx the parse tree
   * @return the visitor result
   */
  visitCondExpressionStatement?: (ctx: CondExpressionStatementContext) => Result

  /**
   * Visit a parse tree produced by `ClangParser.condExpression`.
   * @param ctx the parse tree
   * @return the visitor result
   */
